...
<template>
  <div>
    ...
    <div class="mx-10 chr-width text-justify font-raleway backdrop-blur p-3 border-2 border-main shadow-lg rounded-md">
      ...
      useful in our day-to-day lives. Although I have not yet had the
      opportunity to work on a team, I am eager to collaborate and am excited to
      work in an agile environment to develop innovative solutions to complex
      problems.
    </div>
  </div>
</template>
